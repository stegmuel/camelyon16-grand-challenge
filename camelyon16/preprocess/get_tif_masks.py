...
if __name__ == '__main__':
    save_dir = '/media/thomas/Samsung_T5/CAMELYON-16/tif_masks/'
    xml_queries = ['/media/thomas/Samsung_T5/CAMELYON-16/training/lesion_annotations/*.xml',
                   '/media/thomas/Samsung_T5/CAMELYON-16/testing/lesion_annotations/*.xml']
    image_queries = ['/media/thomas/Samsung_T5/CAMELYON-16/training/tumor/*.tif',
                     '/media/thomas/Samsung_T5/CAMELYON-16/testing/images/*tif']
