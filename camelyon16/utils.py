...
#
TUMOR_WSI_PATH_DICT = {'thomas': '/media/thomas/Samsung_T5/CAMELYON-16/training/tumor/'}
TUMOR_WSI_PATH = TUMOR_WSI_PATH_DICT[user]
# NORMAL_WSI_PATH = DATA_DIR + 'TrainingData/Train_Normal'
TUMOR_MASK_PATH_DICT = {'thomas': '/media/thomas/Samsung_T5/CAMELYON-16/testing/evaluation/evaluation_masks/'}
TUMOR_MASK_PATH = TUMOR_MASK_PATH_DICT[user]
...
PATCHES_TUMOR_NEGATIVE_PATH_DICT = {'thomas': '/media/thomas/Samsung_T5/CAMELYON-16/patches/1920/tumor_negatives/'}
PATCHES_TUMOR_NEGATIVE_PATH = PATCHES_TUMOR_NEGATIVE_PATH_DICT[user]
PATCHES_NORMAL_NEGATIVE_PATH_DICT = {'thomas': '/media/thomas/Samsung_T5/CAMELYON-16/patches/1920/normal_negatives/'}
PATCHES_NORMAL_NEGATIVE_PATH = PATCHES_NORMAL_NEGATIVE_PATH_DICT[user]
PATCHES_TUMOR_POSITIVE_PATH_DICT = {'thomas': '/media/thomas/Samsung_T5/CAMELYON-16/patches/1920/tumor_positives/'}
...
#
NUM_NEGATIVE_PATCHES_FROM_EACH_BBOX = 75
NUM_POSITIVE_PATCHES_FROM_EACH_BBOX = 100
